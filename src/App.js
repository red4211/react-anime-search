...
class App extends Component {
  ...
  changeSeason = e => {
    this.setState({ season: e.target.value }, () => {
      ...
      var query = `query RunSearch(${sq +
        seas1} $mType: MediaType, $filterMethod:[MediaSort] ){
  ...
  showNext = () => {
    if (this.state.pageInfo.hasNextPage === true) {
      ...
      var query = `query RunSearch(${sq +
        seas1} $mType: MediaType, $filterMethod:[MediaSort], $nextPage:Int){
  ...
  showPrev = () => {
    if (this.state.pageInfo.currentPage !== 1) {
      ...
      var query = `query RunSearch(${sq +
        seas1} $mType: MediaType, $filterMethod:[MediaSort], $prevPage:Int){
...
function List(props) {
  const listPanels = props.mediaList.map((elem, index) => {
    ...
    return (
      <li key={index}>
        <a href="#" className="cover-img" style={completedStyle}></a>
  ...
  return (
    <div className="main">
      <div className="btn-container">
        <button onClick={props.showPrev} className="btn-1">
          Back
        </button>
        <button onClick={props.showNext} className="btn-1">
          Next
        </button>
      </div>
  ...
  return (
    <div>
      ...
      <ul className="type-filter">
        <li name="ANIME" onClick={props.setType} className={animeActive}>
          Anime
        </li>
        <li name="MANGA" onClick={props.setType} className={mangaActive}>
          Manga
        </li>
      </ul>
    </div>
